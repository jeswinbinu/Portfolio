...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Jeswin.</span> I'm a{" "}
        <span className="font-bold">software engineer</span>. I'm currently working with Python, YOLO, FaceNet and React.js.
      </motion.h1>
      ...
      >
        <a
          ...
          href="https://github.com/jeswinbinu"
          target="_blank"
        >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/jeswinbinu/"
          target="_blank"
        >
