...
import cryptoXImg from "@/public/cryptox.png"
import mecAttendanceImg from "@/public/mecattendance.png"
...
export const projectsData = [
  {
    title: "Crypto X",
    description:
      "Web-based crypto wallet developed using React and Supabase. Allows users to manage and track their cryptocurrency holdings with a user-friendly interface.",
    role: "Web Developer",
    duration: "1 Week",
  ...
  },
  {
    title: "MecAttendance",
    description:
      "Face detection system that simplifies attendance tracking for educational institutions. Utilizes advanced machine learning algorithms to offer an efficient and secure solution.",
    role: "ML Engineer",
    duration: "3 Weeks",
    technologies: ["Python", "DeepFace", "YOLO", "FaceNet", "Streamlit"],
    teamSize: 4,
    tags: ["Python", "DeepFace", "YOLO", "FaceNet", "Streamlit"],
    icons: [
      "logos:python",
      "logos:deepface",
      "logos:yolo",
...
export const skillsData = [
  ...
  // {
  //   name: "Resilience",
  //   icon: "logos:resilience",
  // },
  // {
  //   name: "Adaptability",
  //   icon: "logos:adaptability",
  // },
  // {
  //   name: "Teamwork",
  //   icon: "logos:teamwork",
  ...
  //   icon: "logos:problem-solving",
  // },
  // {
  //   name: "Communication Skills",
  //   icon: "logos:communication",
  // },
  // {
  ...
  //   icon: "logos:leadership",
  // },
  // {
  //   name: "Organizational Skills",
  //   icon: "logos:organization",
  // },
  // {
